\problemname{Amanda Lounges}
\illustration{.3}{amandaAir.jpg}{H.~A.~Hansen, cc-by-sa}
...
% For some routes, lounges need to be built at both airports, others
% may require only one lounge at either of the airports and for some
% few routes, she does not want any lounges to be built.

% She stresses that the requirements are non-negotiable; If the route
% says no lounges, then the two airports should indeed not have a
% lounge, etc.
