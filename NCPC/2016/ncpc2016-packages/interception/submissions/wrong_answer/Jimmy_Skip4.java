...
public class Jimmy_Skip4 {
    private final static int skipMask = 4;
    ...
    public Jimmy_Skip4(int noHouses, ArrayList<Talk> talks, int c1, int c2) {
...
//        long tm = System.currentTimeMillis();
        ...
        List<Pair> solution = new Jimmy_Skip4(n, talks, c1, c2).solve();
