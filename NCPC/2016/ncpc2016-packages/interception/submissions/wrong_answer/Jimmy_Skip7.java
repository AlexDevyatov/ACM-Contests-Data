...
public class Jimmy_Skip7 {
    private final static int skipMask = 7;
    ...
    public Jimmy_Skip7(int noHouses, ArrayList<Talk> talks, int c1, int c2) {
...
//        long tm = System.currentTimeMillis();
        ...
        List<Pair> solution = new Jimmy_Skip7(n, talks, c1, c2).solve();
