...
public class Jimmy_Skip1 {
    private final static int skipMask = 1;
    ...
    public Jimmy_Skip1(int noHouses, ArrayList<Talk> talks, int c1, int c2) {
...
//        long tm = System.currentTimeMillis();
        ...
        List<Pair> solution = new Jimmy_Skip1(n, talks, c1, c2).solve();
