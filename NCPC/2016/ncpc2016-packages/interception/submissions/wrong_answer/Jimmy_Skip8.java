...
public class Jimmy_Skip8 {
    private final static int skipMask = 8;
    ...
    public Jimmy_Skip8(int noHouses, ArrayList<Talk> talks, int c1, int c2) {
...
//        long tm = System.currentTimeMillis();
        ...
        List<Pair> solution = new Jimmy_Skip8(n, talks, c1, c2).solve();
