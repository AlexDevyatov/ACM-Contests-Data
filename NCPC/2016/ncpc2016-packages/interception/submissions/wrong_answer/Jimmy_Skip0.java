...
public class Jimmy_Skip0 {
    private final static int skipMask = 0;
    ...
    public Jimmy_Skip0(int noHouses, ArrayList<Talk> talks, int c1, int c2) {
...
//        long tm = System.currentTimeMillis();
        ...
        List<Pair> solution = new Jimmy_Skip0(n, talks, c1, c2).solve();
