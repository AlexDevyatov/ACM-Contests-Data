...
public class Jimmy_Skip2 {
    private final static int skipMask = 2;
    ...
    public Jimmy_Skip2(int noHouses, ArrayList<Talk> talks, int c1, int c2) {
...
//        long tm = System.currentTimeMillis();
        ...
        List<Pair> solution = new Jimmy_Skip2(n, talks, c1, c2).solve();
