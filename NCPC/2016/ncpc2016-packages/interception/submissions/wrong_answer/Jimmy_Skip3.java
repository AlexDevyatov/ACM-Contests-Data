...
public class Jimmy_Skip3 {
    private final static int skipMask = 3;
    ...
    public Jimmy_Skip3(int noHouses, ArrayList<Talk> talks, int c1, int c2) {
...
//        long tm = System.currentTimeMillis();
        ...
        List<Pair> solution = new Jimmy_Skip3(n, talks, c1, c2).solve();
